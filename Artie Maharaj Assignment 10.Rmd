...
median_by_room <-tidy_johnson_data %>%
   group_by(Room)%>%
...
#I realized that I needed to create a long format for the data for this part to work? 

update_median <- median_by_room %>%
  gather(`Q1_median`, `Q2_median`, `Q3_median`, `Q4_median`,    
         key = "Quarter",
         value = "median.ratings")

update_median %>%
ggplot(aes(x = Quarter, y = median.ratings, color = Room))+ 
  geom_line() +
labs(x = "Quarter",
     y = "Median Ratings")
