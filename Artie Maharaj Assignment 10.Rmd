...
# I am missing something here...can't figure out why my lines aren't showing up in
# the graph. I am thinking it has to do with my geom_line (), but not sure what goes
#in there. 
